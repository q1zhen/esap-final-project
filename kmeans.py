...
location = "WORLD"
with open(f'/Users/massivezappy/Desktop/ESAP/FinalProject/final-project/nigelsMadness/pythonProject/output/merged/cleaned_nodes.json', 'r') as file:
	raw = json.load(file)
...
for k in [50, 500, 5000]:
	...
	plt.xlabel('X Coordinate')
	plt.ylabel('Y Coordinate')
	plt.savefig(f'cheezhenPlots/kmeans_{location}_{k}_.png', dpi=2000, bbox_inches='tight')
	plt.show()
